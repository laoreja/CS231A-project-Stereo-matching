...
Input file is the pickle generated by SceneFlow_divide_test_train.py
...
and
    ...
    output_directory/validation-00000-of-00016
    output_directory/validation-00001-of-00016
    ...
    output_directory/validation-00015-of-00016

where we have selected 1024 and 16 shards for each data set. Each record
...
Since every image in this dataset is 540 (height) * 960 (width), 
I do not store height and width.
"""
...
def _convert_to_example(filename, relative_dir, left_image, right_image, disparity, mask):
    ...
    Args:
        ...
        left_image, right_image: string, numpy arrays of RGB image
        disparity: numpy array containing float formatted grount-truth disparity
        mask: numpy array containing unit8 formatted grount-truth disparity mask
    Returns:
        Example proto
    """
...
def _process_image_files_batch(thread_index, ranges, name, filenames, relative_dirs, num_shards):
    ...
    Args:
        ...
        filenames: list of strings; each string is a img filename
        relative_dirs: list of strings; each string is the relative folder path in the png/disparity folder
...
def _process_image_files(name, cnt, record_list, num_shards):
    ...
    Args:
        name: string, unique identifier specifying the data set
        cnt: subset num of examples
        record_list: read from the pickle, pickle obtained via running
                    SceneFlow_divide_test_train.py
        num_shards: integer number of shards for this data set.
    """
#    checked
