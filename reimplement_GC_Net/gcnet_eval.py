...
"""
Evaluation for GC-Net on SceneFlow.
"""
...
tf.app.flags.DEFINE_string('log_root', '/home/laoreja/tf/log/gcnet_retrain_6',
                           """Directory where to write event logs' parent.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/laoreja/tf/log/gcnet_retrain_6/train',
