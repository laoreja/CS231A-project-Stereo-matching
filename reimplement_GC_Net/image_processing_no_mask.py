...
def inputs(dataset, batch_size=None, num_preprocess_threads=None):
  ...
  Returns:
    left_images, right_images: Images. 4D tensor of size [batch_size, FLAGS.cropped_height,
                cropped_width, 3].
    disparitys: 3D tensor of size [batch_size, FLAGS.cropped_height, cropped_width].
  """
  if not batch_size:
...
def image_preprocessing(left_image, right_image, disparity, train):
...
def batch_inputs(dataset, batch_size, train, num_preprocess_threads=None,
  ...
  with tf.name_scope('batch_processing'):
    ...
    for thread_id in range(num_preprocess_threads):
      ...
      left_image, right_image, disparity = parse_example_proto(
          example_serialized)
      left_image, right_image, disparity = image_preprocessing(left_image, right_image, disparity, train)
      data.append([left_image, right_image, disparity])
